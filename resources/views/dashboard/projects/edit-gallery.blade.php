<x-app-layout>
    ...
    @push('ESmodules')
        ...
        @vite(['resources/assets/js/dashboard/datatables/common.js', 'resources/assets/js/dashboard/datatables/behavior.js', 'resources/assets/js/dashboard/datatables/projectGalleries.js'])
    @endpush
</x-app-layout>
