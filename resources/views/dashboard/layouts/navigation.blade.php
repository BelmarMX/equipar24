        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-7 sm:-my-px sm:ms-10 sm:flex">
                    @include('dashboard.layouts.nav-links')
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div><i class="fa-solid fa-user-astronaut me-1"></i> {{ Auth::user()->name }}</div>
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('toggle-dark-mode')">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                ...
                                <i class="fa-solid fa-power-off me-1"></i> {{ __('Log Out') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
                </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('toggle-dark-mode')">
                    <i class="fa-solid fa-moon me-1"></i> Dark mode: {{ Auth::user() -> dark_mode ? 'On' : 'Off' }}
