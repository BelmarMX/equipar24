<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center">
            @include('dashboard.partials.section-title', ['section_name'=>'Productos', 'fa_icon'=>'barcode', 'subtitle'=>$record->id ? 'Editar' : 'Nuevo'])
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="md:w-4/12 md:ms-[8.333%] w-full">
                        ...
                        <x-form.file name="data_sheet"
                                     ...
                                     :value="$record->id && $record->data_sheet ? $record->asset_url.'fichas/'.$record->data_sheet : NULL"
                        />
                    </div>
                    <div class="w-full">
