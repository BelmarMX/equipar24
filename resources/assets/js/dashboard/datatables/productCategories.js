...
$(document).ready(function() {
    $('#productCategories-table').DataTable({
        ...
        ,   columns:                [
            ...
            ,   { data: 'count_subcategories', render: count => number_format(count, true) }
                ...
                buttons:                        [
                    {
                        ...
                        ,   action: (e, dt, node, config) => {
                            if( with_trashed )
                            {
                                Alerts.error('No se puede reordenar categorías en la papelera', 'Disculpa las molestias')
                                return
                            }
                            Alerts.html('Modal para reordenar categorías', 'Reordenar Marcas')
