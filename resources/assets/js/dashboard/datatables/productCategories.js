...
$(document).ready(function() {
    $('#productCategories-table').DataTable({
        ...
        ,   columns:                [
            ...
            ,   {
                data: null
                ,   render: ({id, count_subcategories}) => {
                    return `<a href="/dashboard/productSubcategories/index/category/${id}" class="font-semibold text-sky-600 hover:text-sky-900">${number_format(count_subcategories, true)}</a>`
                }
            }
